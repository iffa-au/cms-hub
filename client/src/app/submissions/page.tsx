              ...
              items.map((item) => {
                ...
                return (
                  <tr key={item._id} className='bg-card/60'>
                    <td className='px-4 py-6 border-l-2 border-primary w-full'>
                      <h3 className='font-serif text-primary font-bold text-lg mb-1'>{item.title}</h3>
                      {item.synopsis ? (
                        <p className='text-muted-foreground text-xs line-clamp-1'>{item.synopsis}</p>
                      ) : (
                        <p className='text-muted-foreground text-xs line-clamp-1'>—</p>
                      )}
                    </td>
